...
async def start_video_job(prompt: str, image_base64: str) -> str:
    """
    Use predictLongRunning with the image placed inside each instance (instance['image'])
    rather than parameters.referenceImages (which this model doesn't support).
